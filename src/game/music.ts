/**
 * Music system for Bedlam using Web Audio API.
 * Generates quirky, hospital-themed chiptune background music.
 */
...
class MusicSystem {
  ...
  private playNote(freq: number, startTime: number, duration: number, vol: number = 1): void {
    ...
    // Triangle wave for quirky, lighthearted feel
    osc.type = 'triangle';
  ...
  // Gameplay track - busy hospital, quirky management
  ...
  // Menu track - hospital lobby waiting
  ...
  // Victory track - hospital thriving
  ...
  // Game over track - hospital shutdown
